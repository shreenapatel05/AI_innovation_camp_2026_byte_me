# -*- coding: utf-8 -*-
"""Copy of AI_project_final.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lHHCfjF28VOdBp5R4ztvpvGFn31uj7vf
"""

!pip install -q streamlit pandas numpy plotly scikit-learn pyngrok kagglehub wordcloud
...
print("="*80)
print("\n💡 Features:")
print("   • 🤖 AI Symptom Checker with ML predictions")
print("   • 🌍 Global death statistics analysis")
print("   • 📊 Interactive visualizations")
print("   • 👨‍⚕️ Medical recommendations")
print("\n⚠️ Keep this cell running - don't interrupt!")
print("="*80)
